...
# - zeigt Geräte mit Name, RSSI, Typ, Temp/Feuchte (ThermoBeacon)
# - Save Results → speichert Snapshot (JSON)
# - Start/Stop Dump → schreibt JSON-Lines auf Desktop (dekodiert)
# - Start/Stop Raw → schreibt echte Rohpakete (HEX) auf Desktop
